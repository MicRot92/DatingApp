...
The application uses **MS SQL Server** running in a **Docker** container during development. The project was developed using **Visual Studio Code** and focuses on best practices such as separation of concerns, maintainability, and scalability.
